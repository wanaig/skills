...
```json
{
  "patterns": [
    {
      "id": "PAT-001",
      "category": "flutter_widget",
      "subcategory": "state_management",
      "problem": "状态管理未正确处理异步操作",
      "solution": "使用AsyncValue或FutureBuilder处理异步状态",
      "confidence": 0.95,
      "occurrences": 5,
  ...
  "antiPatterns": [
    {
      "id": "ANTI-001",
      "category": "flutter_widget",
      "pattern": "在Widget中直接调用API",
      "impact": "major",
      "detectedBy": "dg_flutter_tester_logic",
      "fixSuggestion": "提取到Repository或Service层"
    }
  ],
  "fixStrategies": [
    {
      "problemType": "platform_compatibility",
      "successfulFixes": 8,
      "avgRounds": 1.5,
      "bestApproach": "使用kIsWeb和Platform.isXXX进行平台判断"
    }
  ]
}
```
...
2. 匹配当前任务类型（如 "flutter_widget"、"state_management"、"platform_compatibility"）
